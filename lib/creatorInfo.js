...
export const CREATOR_CONTACTS = Object.freeze([
  ...
  // Contoh menambah owner kedua:
  // Object.freeze({ name: 'NamaOwnerLain', number: '62xxxxxxxxxx' })
])
...
/**
 * Membangun payload pesan WhatsApp untuk mengirim satu atau beberapa
 * vCard kontak dalam satu bubble.
 *
 * - 1 kontak  -> contactMessage biasa
 * - >1 kontak -> contactsArrayMessage (semua vCard dalam satu bubble)
 *
 * @param {string} [labelSuffix] teks tambahan di displayName, mis. "(Creator)"
 */
